def add_options(parser):
    # fmt: off
    # Dataset
    parser.add_argument("--train-data-file", default="cs-cs-freq-self.var.tok.txt", help="training data")
    ...
    parser.add_argument("--pool_choice", default='last_mean', choices=['last_head', 'last_mean', 'middle', 'first_last_mean'])
